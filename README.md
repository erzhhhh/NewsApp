...
✔ Display title, description, date, and image
✔ Save articles to local SQLite database
✔ View saved articles offline
...
- 📍 **Android SDK**
- 🌐 **NewsAPI.org** — external news API
- 💾 **SQLite** — local database for storing articles
- 📡 **Retrofit / Volley / OkHttp** (depending on network implementation)
- 📦 **Gradle** — build system
